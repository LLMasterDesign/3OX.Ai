...
DOT3OX = File.expand_path('../..', __dir__)
ROOT = File.expand_path('..', DOT3OX)
PULSE_ROOT = File.join(DOT3OX, '(6)Pulse')
...
when 'teleprompt', 'analyze'
  ...
  puts <<~USAGE
    Usage: ruby .3ox/.vec3/rc/run.rb [start|stop|status|queue|once|teleprompt|analyze]
