...
- [ ] Implement **chip linter**: first line matches glyph spine + `::0xHHH::`; reject wrong length / non-hex.
- [ ] Implement **index gate**: claimed codes exist in `hex.index.json`; `owner` present; optional conflict detector.
